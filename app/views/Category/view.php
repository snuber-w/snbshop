    ...
    <div class="row">
        ...
        <div class="col-lg-12 category-content">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="input-sort"><?php __('item_per_page'); ?>:</label>
                        <select class="form-select" id="input-per_p">

                            <option value="per_p=3" <?php if (isset($_GET['per_p']) && $_GET['per_p'] == '3') echo 'selected' ?>>3</option>
                            <option value="per_p=6" <?php if (isset($_GET['per_p']) && $_GET['per_p'] == '6') echo 'selected' ?>>6</option>
                            <option value="per_p=10" <?php if (isset($_GET['per_p']) && $_GET['per_p'] == '10') echo 'selected' ?>>10</option>
                            <option value="per_p=50" <?php if (isset($_GET['per_p']) && $_GET['per_p'] == '50') echo 'selected' ?>>50</option>
                            <option value="per_p=100" <?php if (isset($_GET['per_p']) && $_GET['per_p'] == '100') echo 'selected' ?>>100</option>
                        </select>
                    </div>
                </div>
            </div>
