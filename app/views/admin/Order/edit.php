...
<div class="card">
    ...
    <div class="card-body">
        ...
        <?php if (!$order[0]['status']): ?>
            <a href="<?php echo ADMIN; ?>/order/edit?id=<?php echo $order[0]['order_id']; ?>&status=1" class="btn btn-success btn-flat">Изменить статус на Завершен</a>
        <?php else: ?>
            <a href="<?php echo ADMIN; ?>/order/edit?id=<?php echo $order[0]['order_id']; ?>&status=0" class="btn btn-danger btn-flat">Изменить статус на Новый</a>
        <?php endif; ?>
