            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="price" class="form-control" id="price" placeholder="Цена" value="<?php
                        echo get_field_value('price') ?: 0 ?>">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="old_price">Старая цена</label>
                        <input type="text" name="old_price" class="form-control" id="old_price" placeholder="Старая цена" value="<?php
                        echo get_field_value('old_price') ?: 0 ?>">
                    </div>
                </div>
            </div>
                        ...
                        <?php foreach (\wfm\App::$app->getProperty('languages') as $k => $lang): ?>
                            <div class="tab-pane fade <?php if ($lang['base']) echo 'active show' ?>" id="<?php echo $k; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description[<?php echo $lang['id']; ?>][title]" class="form-control" id="title" placeholder="Наименование товара" value="<?php echo get_field_array_value('product_description', $lang['id'], 'title'); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="description">Мета-описание</label>
                                    <input type="text" name="product_description[<?php echo $lang['id']; ?>][description]" class="form-control" id="description" placeholder="Мета-описание" value="<?php echo get_field_array_value('product_description', $lang['id'], 'description'); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="keywords">Ключевые слова</label>
                                    <input type="text" name="product_description[<?php echo $lang['id']; ?>][keywords]" class="form-control" id="keywords" placeholder="Ключевые слова" value="<?php echo get_field_array_value('product_description', $lang['id'], 'keywords'); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="exerpt" class="required">Краткое описание</label>
                                    <input type="text" name="product_description[<?php echo $lang['id']; ?>][exerpt]" class="form-control" id="exerpt" placeholder="Краткое описание" value="<?php echo get_field_array_value('product_description', $lang['id'], 'exerpt'); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="content">Описание товара</label>
                                    <textarea name="product_description[<?php echo $lang['id']; ?>][content]" class="form-control editor" id="content" rows="3" placeholder="Описание товара"><?php echo get_field_array_value('product_description', $lang['id'], 'content'); ?></textarea>
                                </div>
